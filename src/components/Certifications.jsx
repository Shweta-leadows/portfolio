  ...
  return (
    <div ref={containerRef} className="relative min-h-[200vh]">
      ...
      >
        ...
        {/* MOBILE LAYOUT */}
        <div className="block md:hidden w-full min-h-screen flex items-center justify-center relative z-10">
          <motion.div
            ref={contentRef}
            variants={containerVariants}
            initial="hidden"
            animate={isInView ? "visible" : "hidden"}
            className="w-full px-5 py-16 space-y-8"
          >
            {/* HEADER */}
            <motion.div variants={titleVariants} className="text-center">
              <h2 className="text-[#e8e3da] text-[2.5rem] font-black leading-[0.9] tracking-tighter mb-3">
                CERTIFICATIONS
              </h2>
            ...
            <div className="space-y-5">
              {displayedCerts.map((cert, index) => (
                ...
                >
                  ...
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden shadow-xl hover:bg-white/10 transition-all duration-300">
                    {/* Image */}
                    ...
                    <div className="p-4">
                      ...
                      {/* Title */}
                      <h3 className="text-white text-lg font-black mb-2 leading-tight line-clamp-2">
                        {cert.title}
                      </h3>
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {cert.skills.slice(0, 3).map((skill, i) => (
                          <span
                            key={i}
                            className="px-2.5 py-1 bg-white/5 text-neutral-300 rounded-full text-[0.65rem] font-medium border border-white/10"
                          >
                            {skill}
                          </span>
                        ))}
                        {cert.skills.length > 3 && (
                          <span className="px-2.5 py-1 text-neutral-500 text-[0.65rem] font-medium">
                            +{cert.skills.length - 3}
                          </span>
                        )}
                      </div>
            ...
            {certifications.length > 3 && (
              ...
              >
                ...
                >
                  <div className="absolute -inset-1 bg-gradient-to-r from-white/20 via-white/10 to-white/20 rounded-full blur opacity-50 group-hover:opacity-75 transition duration-300"></div>

                  <div className="relative flex items-center justify-center gap-2 px-6 py-3.5 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 group-hover:bg-white/15 transition-all duration-300">
                    <svg
                    ...
                    <div className="text-left flex-1">
                      ...
                      <div className="text-neutral-300 text-[0.65rem]">
        ...
        {/* DESKTOP LAYOUT */}
        <div className="hidden md:flex w-full min-h-screen items-center justify-center relative z-10">
          <motion.div
            ref={contentRef}
            className="w-full max-w-[1600px] mx-auto px-6 sm:px-8 md:px-12 lg:px-16 xl:px-20 py-12 md:py-16"
            variants={containerVariants}
            initial="hidden"
            animate={isInView ? "visible" : "hidden"}
          >
            <div className="w-full">
              ...
              <motion.div variants={titleVariants} className="mb-8 md:mb-12">
                <h2 className="text-[#e8e3da] text-[3rem] md:text-[3.5rem] lg:text-[4rem] xl:text-[5rem] font-black leading-[0.9] tracking-tighter mb-3">
                  CERTIFICATIONS
                </h2>
                <div className="h-1 w-16 bg-gradient-to-r from-white to-transparent"></div>
              </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-8 mb-6 md:mb-8">
                {displayedCerts.map((cert, index) => (
                  ...
                  >
                    {/* Certificate Card */}
                    <div className="bg-neutral-900/50 backdrop-blur-sm border border-neutral-800 rounded-2xl overflow-hidden shadow-2xl hover:border-neutral-700 hover:shadow-neutral-800/50 transition-all duration-300 h-full flex flex-col">
                      {/* Certificate Image */}
                      ...
                      <div className="p-6 flex-1 flex flex-col">
                        ...
                        <h3 className="text-white text-2xl font-bold mb-3 group-hover:text-neutral-100 transition-colors leading-tight">
                          {cert.title}
                        </h3>
              ...
              {certifications.length > 3 && (
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative flex items-center gap-3 px-10 py-4 bg-gradient-to-r from-neutral-800 to-neutral-900 rounded-full border border-neutral-700 group-hover:border-neutral-600 transition-all duration-300 shadow-2xl">
